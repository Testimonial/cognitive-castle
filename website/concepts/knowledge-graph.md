...
Cognitive Castle includes a temporal entity-relationship graph — like Zep's Graphiti, but SQLite instead of Neo4j. Local and free.
...
Graphiti, for example, also exposes a bi-temporal model. Cognitive Castle's
