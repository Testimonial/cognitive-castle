...
```bash
castle wake-up --wing driftwood > context.txt
```
...
```bash
castle search "auth decisions" > results.txt
...
- **LanceDB** on your machine — vector storage and search
