...
class Layer0:
    ...
    Reads from ~/.castle/identity.txt — a plain-text file the user writes.
    ...
    def __init__(self, identity_path: str = None):
        if identity_path is None:
            identity_path = os.path.expanduser("~/.castle/identity.txt")
...
class Layer3:
    ...
    Reuses searcher.py logic against castle_drawers.
    """
