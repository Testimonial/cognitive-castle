...
Adapted for Cognitive Castle: works standalone on plain text and ChromaDB drawers.
...
class Dialect:
    ...
    def __init__(
        ...
        from cognitive_castle.i18n import load_lang, t, current_lang, get_regex
    ...
    # === PLAIN TEXT COMPRESSION (new for Cognitive Castle) ===
