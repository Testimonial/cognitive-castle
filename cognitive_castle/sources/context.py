...
import ``cognitive_castle.palace`` directly — that coupling is what the facade
exists to prevent.
...
class _CollectionLike(Protocol):
    """Minimum of :class:`cognitive_cognitive_castle.backends.BaseCollection` adapters rely on.
