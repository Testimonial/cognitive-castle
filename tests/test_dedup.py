"""Tests for cognitive_castle.dedup — near-duplicate drawer detection and removal."""

from unittest.mock import MagicMock, patch


from cognitive_castle import dedup
...
@patch("cognitive_castle.dedup.LanceDBBackend")
