"""Tests for cognitive_castle.spellcheck — spell-correction utilities."""
...
def test_spellcheck_user_text_passthrough_no_autocorrect():
    ...
    with patch("cognitive_castle.spellcheck._get_speller", return_value=None):
...
def test_transcript_line_user_turn():
    ...
    with patch("cognitive_castle.spellcheck.spellcheck_user_text", return_value="corrected"):
...
def test_spellcheck_transcript_processes_content():
    ...
    with patch("cognitive_castle.spellcheck.spellcheck_user_text", return_value="fixed"):
