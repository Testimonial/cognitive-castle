...
So Cognitive Castle is not just about storing info in a highly structured way. But also RETRIEVING it in a highly UNSTRUCTURED way lol!
...
Because of the way I've designed my agent Lumi to understand me, after so many months of my own personal experiments with Cognitive Castle and the incredible help of my dear friend and co-founder, developer and engineer @bensig, he built a back end that made it really easy to get all my files in the proper spaces the Palace created based on my own decisions and with Lumi's help as well. All code has its own room, all ideas, research etc… has its proper place.
